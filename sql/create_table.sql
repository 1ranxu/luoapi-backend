...
values (1705234447153963010, '随机毒鸡汤', 'http://localhost:8012/api/poisonousChickenSoup', 1709135865515171844, 'GET',
        NULL, 1, 'http://localhost:8012/api/poisonousChickenSoup', NULL, NULL, '随机毒鸡汤', 1, 228, '', 'JSON',
        '[{\"fieldName\":\"code\",\"type\":\"int\",\"desc\":\"响应码\"},
          {\"fieldName\":\"data.text\",\"type\":\"string\",\"desc\":\"随机毒鸡汤\"},
          {\"fieldName\":\"message\",\"type\":\"string\",\"desc\":\"响应描述\"}]'),

       (1705237104270712833, '获取输入的名称', 'http://localhost:8012/api/name', 1709135865515171844, 'GET',
        '[{\"fieldName\":\"name\",\"type\":\"string\",\"desc\":\"输入的名称\",\"required\":\"是\"}]',
        1, 'http://localhost:8012/api/name?name=zhangshan', NULL, NULL, '获取输入的名称', 1, 36,
       ...
       (1705237990061580289, '随机壁纸', 'http://localhost:8012/api/randomWallpaper', 1709135865515171844, 'GET',
        ...
        1, 'http://localhost:8012/api/randomWallpaper?lx=dongman', NULL, NULL, '获取随机壁纸', 1, 97,
       ...
       (1705238841173942274, '每日星座运势', 'http://localhost:8012/api/horoscope', 1709135865515171844, 'GET',
        ...
        1, 'http://localhost:8012/api/horoscope?type=scorpio&time=nextday', NULL, NULL, '获取每日星座运势', 1, 23,
       ...
       (1705239469589733378, '随机土味情话', 'http://localhost:8012/api/loveTalk', 1709135865515171844, 'GET', NULL, 1,
        'http://localhost:8012/api/loveTalk', NULL, NULL, '获取土味情话', 1, 413,
       ...
       (1705239928861827073, '获取IP信息归属地', 'http://localhost:8012/api/ipInfo', 1709135865515171844, 'GET',
        '[{\"fieldName\":\"ip\",\"type\":\"string\",\"desc\":\"输入IP地址\",\"required\":\"是\"}]',
        1, 'http://localhost:8012/api/ipInfo?ip=58.154.0.0', NULL, NULL, '获取IP信息归属地详细版', 1, 59,
       ...
       (1705240565347459073, '获取天气信息', 'http://localhost:8012/api/weather', 1709135865515171844, 'GET',
        ...
        1, 'http://localhost:8012/api/weather?ip=180.149.130.16', NULL, NULL, '获取每日每周的天气信息', 1, 109,
